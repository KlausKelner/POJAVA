...
public class CalculationsBC546{

  public static void main(String[] args) {
	  
    String s = "**** The calculations for transistor BC546 ****";
 
	double RL = 1;					//Resistive Load
	double h11 = 8.7;				//input impedance hie
	double h12 = 0.0003;			//reverse voltage hre
	...
	File file = new File("Calculations_for_BC546.txt");
