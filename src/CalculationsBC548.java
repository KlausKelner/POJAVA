...
public class CalculationsBC548{

  public static void main(String[] args) {
	  
    String s = "**** The calculations for transistor BC548 ****";
 
	double RL = 1;					//Resistive Load
	double h11 = 2.7;				//input impedance hie
	double h12 = 0.00015;			//reverse voltage hre
	double h21 = 220;				//current gain hfe	
	double h22 = 18;				//output admitance hoe
