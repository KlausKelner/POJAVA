...
public class ChartPanelIcUbe {
	
    private static String title = "POJAVA Projekt Tranzystor Ic / Ube";
    ...
    public ChartPanelIcUbe(String title,Transistor t) {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                ChartPanelIcUbe cpd = new ChartPanelIcUbe(title,t);
            }
        });
    }
}